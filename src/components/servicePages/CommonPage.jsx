    ...
    {restWords}
          ...
          {data.sections &&
            data.sections.map((section, sectionIdx) => {
              ...
              const isAdvancedSection =
                ...
                section.title.includes("CAPABILITIES");
              const isOutcomeSection = section.title.includes("OUTCOME");
              const isTechSection =
                section.title.includes("TECHNOLOGY") ||
                section.title.includes("TECHNOLOGIES") ||
                section.title.includes("CHANNELS") ||
                section.title.includes("TOOLS") ||
                section.title.includes("INFRASTRUCTURE");
                          ...
                          <div
                            ...
                            className={`group border border-white/5 rounded-xl p-6 bg-white/[0.02] hover:bg-white/[0.03] hover:border-[#29f67a]/20 transition-all duration-300 ${
                              section.categories.length === 1
                                ? "md:col-span-2"
                                : section.categories.length % 2 !== 0 &&
                                    catIdx === section.categories.length - 1
                                  ? "md:col-span-2"
                                  : ""
                            }`}
                          >
        ...
        {data.stats && (
          <motion.div
            ...
            style={{
              background:
                "linear-gradient(135deg, rgba(41, 246, 122, 0.05) 0%, rgba(0, 0, 0, 0.4) 100%)",
        ...
        >
          ...
          <h2 className="text-4xl md:text-6xl font-light text-white mb-8 tracking-tighter">
            Ready to <span className="text-[#29f67a] font-bold">evolve ?</span>
          </h2>
          ...
          <div className="mt-12 flex justify-center gap-8 text-[10px] font-bold text-slate-500 tracking-[0.2em] flex-wrap">
            <span className="flex items-center gap-2">
              <FiCheckCircle className="text-[#29f67a]" /> ENTERPRISE READY
            </span>
            <span className="flex items-center gap-2">
              <FiCheckCircle className="text-[#29f67a]" /> EXPERT TEAM
            </span>
            <span className="flex items-center gap-2">
              <FiCheckCircle className="text-[#29f67a]" /> 24/7 SUPPORT
            </span>
          </div>
        </motion.div>
      </div>
