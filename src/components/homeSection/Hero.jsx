...
export default function HeroSection() {
  ...
  return (
    <div ref={containerRef} className="relative min-h-screen w-full overflow-hidden bg-[#050505] flex flex-col lg:flex-row items-center px-6 md:px-12 lg:px-20 py-20 mt-5 md:mt-0">
